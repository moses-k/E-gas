...
public class FragmentGasProductNewAll extends Fragment {
    private  String className = FragmentGasProductNewAll.class.getSimpleName();

    public FragmentGasProductNewAll() {
    }

    public static FragmentGasProductNewAll newInstance() {
        FragmentGasProductNewAll fragment = new FragmentGasProductNewAll();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        List<GasProduct> items = DataGenerator.getShoppingProductnew(getActivity());
