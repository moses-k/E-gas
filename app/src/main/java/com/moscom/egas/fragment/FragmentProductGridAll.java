...
public class FragmentProductGridAll extends Fragment {
    private  String className = FragmentProductGridAll.class.getSimpleName();

    public FragmentProductGridAll() {
    }

    public static FragmentProductGridAll newInstance() {
        FragmentProductGridAll fragment = new FragmentProductGridAll();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new SpacingItemDecoration(3, Tools.dpToPx(getActivity(), 8), true));
        recyclerView.setHasFixedSize(true);

        //inject data from the database
        List<GasProduct> items = DataGenerator.getShoppingProductrefill(getActivity());
